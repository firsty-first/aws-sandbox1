...
public class HelloWorld implements RequestHandler<Map<String , Object>, Map<String, Object>> {
	...
	private Map<String, Object> createErrorResponse(String message) {
		...
		response_map.put("statusCode", 400);
		response_map.put("headers", Map.of("Content-Type", "application/json"));

		response_map.put("body", String.format("{\"statusCode\": %d, \"message\": \"%s\"}", 400, message));
